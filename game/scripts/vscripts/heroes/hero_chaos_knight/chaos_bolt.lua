...
function ChaosBolt( keys )
	...
	damage_table.damage = 300

	ApplyDamage(damage_table)

	print("[Lua] Chaos Bolt file loaded")

	print("ChaosBolt: Target = ", target:GetUnitName())
print("ChaosBolt: Damage = ", damage)
print("ChaosBolt: Applying damage now")
end