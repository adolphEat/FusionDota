...
function updateButtonsSection(buttonsSection, result) {
    ...
    if (result.winner === 'player') {
        ...
        if (hasAugments) {
            // 有海克斯强化时，显示"确认选择"按钮
            const confirmBtn = createStyledButton(buttonsSection, 'ConfirmAugmentButton', '确认选择', () => {
